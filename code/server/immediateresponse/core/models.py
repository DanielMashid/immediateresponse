...
class Profile(models.Model):
    ...
    organization_number = models.ForeignKey(
        Organization, on_delete=models.CASCADE, related_name="orgumber", null=True)
    avatar = models.ForeignKey(AvatarImage, on_delete=models.CASCADE,
                               related_name="avatarimg", null=True)  # temporary
...
class Event(models.Model):
    ...
    reported_user = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="reportuser", null=True)  # temporary
